...
class V2SREntityReportDetails(EmbeddedDocument):
    ...
    def calculate(self):
        ...
        n_valid_reports = sum([1 for rb in self.reportes_instalaciones if rb.disponibilidad_promedio_porcentage > 0])
        ...
        for i_report in self.reportes_instalaciones:
            if i_report.disponibilidad_promedio_porcentage > 0:
