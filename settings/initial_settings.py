...
REPOS = [EXCEL_REPO, SREMOTO_REPO, SCENTRAL_REPO, OUTPUT_MOTOR_REPO, CONS_REPO, TEMPLATES_REPO]
FINAL_REPO = list()
for repo in REPOS:
...
EXCEL_REPO, SREMOTO_REPO, SCENTRAL_REPO, OUTPUT_MOTOR_REPO, CONS_REPO, TEMPLATES_REPO = FINAL_REPO
