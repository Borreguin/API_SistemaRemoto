...
from app.services.AdminSRemoto.v2.BahiaService_v2 import get_bahia_by_id, create_bahia, update_bahia
...
def v2_bahia_id_endpoints(router: APIRouter):
    ...
    def v2_crea_bahia_usando_ID_como_referencia(installation_id: str, bahia: BahiaRequest, response: Response = Response()):
    ...
    def v2_actualiza_bahia_usando_ID_como_referencia(installation_id: str, document_id: str, bahia: BahiaRequest, response: Response = Response()):
    ...
    def v2_elimina_bahia_usando_ID_como_referencia(installation_id: str, document_id: str, response: Response = Response()):
